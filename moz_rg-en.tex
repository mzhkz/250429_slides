...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{figs/interaction-adversary.png}
...
\item \small The intersection $\mathcal{P} \cap \mathcal{Q}$ contains at least $f+1$ replicas, and since the system has at most $f$ Byzantine replicas, at least $1$ honest replica must have sent COMMIT messages for both values $v$ and $v'$
